(function(f) {
    ...
    return function() {
        ...
        1: [function(require, module, exports) {
            ...
            Object.keys(analytics.Integrations).forEach(function(name) {
                var originalReady = analytics.Integrations[name].prototype.ready;
                analytics.Integrations[name].prototype.ready = function() {
                    var hasLoadedSuccessfully = analytics.failedInitializations.indexOf(name) < 0;
                    analytics.emit("integration-ready:" + name, hasLoadedSuccessfully);
                    originalReady.apply(this)
                }
            })
        }, {
            "../package.json": 129,
            "./integrations": 2,
            "@segment/analytics.js-core": 22
        }],
        2: [function(require, module, exports) {
            ...
            module.exports = {
                ...
                optimizely: require("@canva/analytics.js-integration-optimizely"),
                braze: require("@canva/analytics.js-integration-braze")
            }
        }, {
            "@canva/analytics.js-integration-braze": 3,
            "@canva/analytics.js-integration-optimizely": 4,
            "@segment/analytics.js-integration-google-analytics": 34,
            "@segment/analytics.js-integration-google-tag-manager": 35,
            "@segment/analytics.js-integration-segmentio": 36
        }],
        3: [function(require, module, exports) {
            "use strict";
            var integration = require("@segment/analytics.js-integration");
            var Braze = module.exports = integration("Braze").readyOnLoad().global("appboy").option("apiKey", "").option("clientName", "canva/analytics.js-braze-integration").option("clientVersion", "2.0.1").tag('<script async src="https://js.appboycdn.com/web-sdk/3.0/appboy.core.min.js">');
            Braze.prototype.initialize = function() {
                ...
                window.appboy.initialize(this.options.apiKey, {
            ...
            Braze.prototype.loaded = function() {
                return window.appboyQueue === null
            };
            Braze.prototype.identify = function(identify) {
        ...
        4: [function(require, module, exports) {
            "use strict";
            var integration = require("@segment/analytics.js-integration");
            var OptimizelyApi = module.exports = integration("Optimizely API").option("clientName", "canva/canvalytics-optimizely-api-integration").option("clientVersion", "0.0.1").option("accountId", "").option("projectId", "").option("canvalyticsToOptimizelyIdMap", new Map).option("endpoint", "https://logx.optimizely.com/v1/events");
            OptimizelyApi.prototype.initialize = function() {
                this.ready()
            };
            OptimizelyApi.prototype.track = function(track) {
                const visitorId = getQueryStringValue("ovid");
                if (!visitorId) {
                    return
                }
                const eventName = track.event().replace(/:/g, "_");
                const opts = this.options;
                if (!opts.canvalyticsToOptimizelyIdMap.has(eventName)) {
                    return
                }
                const eventProperties = track.properties() || [];
                const eventData = {
                    visitorId: visitorId,
                    name: eventName,
                    id: opts.canvalyticsToOptimizelyIdMap.get(eventName),
                    properties: eventProperties
                };
                sendEvent(opts, eventData)
            };
            ...
            function uuidv4() {
                if (typeof window !== "undefined" && typeof window.crypto !== "undefined" && typeof window.crypto.getRandomValues === "function") {
                    return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, function(c) {
                        const cN = Number(c);
                        return (cN ^ window.crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> cN / 4).toString(16)
                    })
                } else {
            ...
            function getQueryStringValue(key) {
                ...
                const value = queryString.replace(new RegExp("^(?:.*[&\\?]" + escapedKey + "(?:\\=([^&]*))?)?.*$", "i"), "$1");
                return decodeURIComponent(value)
            }

            function sendEvent(opts, eventData) {
                const url = opts.endpoint;
                const visitorId = eventData.visitorId;
                const payload = {
                ...
                }).then(function(_res) {}).catch(function(_err) {})
            }
        }, {
            "@segment/analytics.js-integration": 39
        }],
        ...
        18: [function(require, module, exports) {
            (function(global) {
                ...
                var IntegrationMiddlewareChain = require("./middleware").IntegrationMiddlewareChain;
                var DestinationMiddlewareChain = require("./middleware").DestinationMiddlewareChain;
        ...
        25: [function(require, module, exports) {
            ...
            function middlewareChain(dest) {
                ...
                return function applyMiddlewares(run, facade, callback) {
                    ...
                    if (typeof callback !== "function") throw new Error("applyMiddlewares requires a function callback");
        ...
        36: [function(require, module, exports) {
            ...
            var Segment = (exports = module.exports = integration("Segment.io").option("apiKey", "").option("apiHost", "api.segment.io/v1").option("crossDomainIdServers", []).option("deleteCrossDomainId", false).option("saveCrossDomainIdInLocalStorage", true).option("retryQueue", true).option("addBundledMetadata", false).option("unbundledIntegrations", [])).option("unbundledConfigIds", []).option("maybeBundledConfigIds", {});
            ...
            Segment.prototype.initialize = function() {
                ...
                if (this.options.retryQueue) {
                    this._lsqueue = new Queue("segmentio", queueOptions, function(elem, done) {
                        ...
                        Segment.sendJsonWithTimeout(item.url, item.msg, item.headers, 10 * 1e3, function(err, res) {
            ...
            Segment.prototype.ampId = function(ctx) {
                ...
                if (ampId) {
                    if (ampId.slice(0, 3) === "amp") ctx.amp = {
                        id: ampId
                    }
                }
            };
            ...
            "@ndhoule/extend": 10,
            "@ndhoule/keys": 13,
            "@segment/ad-params": 17,
            "@segment/analytics.js-integration": 39,
            "@segment/localstorage-retry": 51,
            "@segment/protocol": 56,
            "@segment/send-json": 57,
            "@segment/top-domain": 59,
            "@segment/utm-params": 60,
            "component-clone": 64,
            "component-cookie": 65,
            json3: 87,
            uuid: 38,
        ...
        129: [function(require, module, exports) {
            module.exports = {
                name: "@canva/analytics.js",
                author: "Canva",
                contributors: ["Segment <friends@segment.com>"],
                version: "0.4.3",
                description: "Canvalytics JS loading snippet. Forked from @segment/analytics.js.",
                ...
                repository: {
                    type: "git",
                    url: "https://github.com/canva/analytics.js.git"
                },
                license: "SEE LICENSE IN LICENSE",
                homepage: "https://github.com/canva/analytics.js#readme",
                "//": "Update analytics.js-core to latest once https://github.com/segmentio/analytics.js-core/issues/129 is resolved",
                dependencies: {
                    "@canva/analytics.js-integration-braze": "2.0.2",
                    "@canva/analytics.js-integration-optimizely": "1.0.1",
                    "@segment/analytics.js-core": "4.1.8",
                    "@segment/analytics.js-integration": "3.3.2",
                    "@segment/analytics.js-integration-google-analytics": "2.18.2",
                    ...
                    "@segment/analytics.js-integration-segmentio": "4.4.1"
                },
                devDependencies: {
                    browserify: "^13.0.1",
                    eslint: "^2.9.0",
